...
pub mod setup {
	...
	impl BootstrapConfig {
		...
		/// An RSA keypair cannot be generated on-the-fly because it has to be generated from a
		/// `.pk8` file. Hence the `Option` parameter is always `None` except in the case of RSA.
		...
		///
		/// This function will panic if the RSA key type is specified and then the
		/// `rsa_pk8_filepath` is set to `None`. It will panic if the file contains invalid data and
		/// an RSA keypair cannot be generated from it.
