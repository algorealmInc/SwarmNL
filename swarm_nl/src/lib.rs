...
pub mod core {
    ...
    impl Core {
        ...
        /// We will trigger the dial by sending a message into the stream. This is an intra-network layer communication,
        /// multiplexed over the undelying open stream.
                    ...
                    stream_data = receiver.select_next_some() => match stream_data {
                            ...
                            StreamData::Application(app_data) => {
                                match app_data {
                                    ...
                                    AppData::KademliaStore { key, value, expiration_time } => {
                                        // create a kad record
