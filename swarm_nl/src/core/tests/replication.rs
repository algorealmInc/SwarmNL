...
use crate::{
	core::{
		gossipsub_cfg::GossipsubConfig, replication::{ConsensusModel, ConsistencyModel, ReplNetworkConfig}, Core, CoreBuilder, NetworkEvent, ReplicaBufferQueue, RpcConfig
	},
...
#[test]
fn repl_itest_join_and_exit_works() {
	// Node 1 keypair
