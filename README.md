...
## Why SwarmNl?
SwarmNl helps you set up your p2p decentralized and distributed network stack for your application quickly and with great ease. You can easily configure nodes, set custom network conditions and behaviour perculiar to your problem scope ane begin networking.
All the hassles and fun of networking has been taken care of for you, you only need to worry about simple configurations. What you need is just to integrate with the library and begin networking. That easy!
